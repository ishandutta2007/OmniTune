...
def _patch_dist_checkpoint_preload() -> None:
    ...
    if getattr(filesystem_async.FileSystemWriterAsync.preload_tensors, "_omnitune_patched", False):
        return
    ...
    preload_tensors._omnitune_patched = True
...
def _patch_dataset_helper_compilation() -> None:
    ...
    if getattr(dataset_utils.compile_helpers, "_omnitune_patched", False):
        return
    ...
    compile_helpers._omnitune_patched = True
