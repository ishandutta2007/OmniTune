...
def ensure_create_sft_dataset_applies_chat_template() -> None:
    ...
    if getattr(sft_module.create_sft_dataset, "_omnitune_chat_template_patched", False):
        return
    ...
    create_sft_dataset._omnitune_chat_template_patched = True  # type: ignore[attr-defined]
