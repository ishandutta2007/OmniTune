...
def _prepare_hp_args(finetuning_args: "FinetuningArguments", model_args: "ModelArguments"):
    r"""Load HyperParallel arguments and apply OmniTune-side overrides.
    ...
    from hyper_parallel.integration.omnitune import HyperParallelArguments  # pylint: disable=C0415
