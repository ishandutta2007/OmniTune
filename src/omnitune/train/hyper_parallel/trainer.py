...
"""HyperParallel distributed trainer for OmniTune."""
...
import torch
from hyper_parallel.integration.omnitune import (
    HSDPModule,
...
from hyper_parallel.integration.omnitune.context_parallel import (
    cp_prepare_model,
    get_cp_rank,
    get_dp_rank,
    shard_inputs_for_cp,
)
from hyper_parallel.integration.omnitune.expert_parallel import ep_prepare_model
