...
class DataEngine(Dataset):
    ...
    def _get_dataset_info(self) -> None:
        ...
        elif self.path.endswith(".yaml"):  # hf hub uri, e.g. omnitune/v1-sft-demo/dataset_info.yaml
        ...
        else:  # hf hub dataset, e.g. omnitune/v1-sft-demo
...
if __name__ == "__main__":
    """
    python -m omnitune.v1.core.data_engine --train_dataset data/v1_sft_demo.yaml
    python -m omnitune.v1.core.data_engine --train_dataset data/v1_dpo_demo.yaml
    """
