...
USAGE = (
    ...
    + "\n"
    + "| Usage:                                                             |\n"
    + "|   omnitune-cli api -h: launch an OpenAI-style API server       |\n"
    + "|   omnitune-cli chat -h: launch a chat interface in CLI         |\n"
...
if __name__ == "__main__":
    from omnitune.train.tuner import run_exp  # use absolute import
