...
LOCALES = {
    ...
    "subtitle": {
        ...
        "zh": {
            "value": (
                "<h3><center>访问 <a href='https://github.com/hiyouga/OmniTune' target='_blank'>"
                "GitHub 主页</a> <a href='https://omnitune.readthedocs.io/zh-cn/latest/' target='_blank'>"
                "官方文档</a> <a href='https://blog.omnitune.net/' target='_blank'>"
                "博客</a></center></h3>"
            ),
        },
        "ko": {
